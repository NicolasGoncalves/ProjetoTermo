    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println(bold + "Regras: \n" + reset
                    ...
                    + "3.As letras" + amarelo + " amarelas " + reset
                    + "estão na posição errada, porém, pertencem a palavra oculta\n"
        ...
        do {
            ...
            do {
                ...
                System.out.println(
                        bold + "Quer jogar de novo? " + azul + "Sim " + reset + "ou" + vermelho + " Não" + reset);
                System.out.print(roxo);
